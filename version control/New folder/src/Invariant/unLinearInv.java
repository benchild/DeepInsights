...
public class unLinearInv extends Invariant
{
	public LinkedList<Term> list = new LinkedList<Term>();
	double[] par;
	public unLinearInv(LinkedList<Term> li, double[] res) 
	{
	...
	public String toPrefix() {
		switch (list.get(1).type) {
			...
			case "rec": return "= "+"a"+list.get(0).x+" (+ (/ "+String.format("%.2f", par[1])+" a"+list.get(1).y+") "+par[0]+")";
